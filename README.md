...
## Initial Milestone
The first milestone will be the design and verification of a RISC-V processor in SystemVerilog while emphasizing methodology rather than simply producing a working CPU. 
...
## Long-Term Direction
Over time, it will expand to include more advanced architecture features, memory systems, verification infrastructure, FPGA implementation, and research-inspired extensions.
